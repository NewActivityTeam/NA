...
function(a) {
    ...
    d = function() {
        ...
        n = function(a, c) {
            ...
            return e.reduce(function(a, b) {
                var e = d(a);
                return c(d(e), b) ? e[e.length] = b: a[a.length] = [b],
                a
            },
            [[b(a)]])
        },
    ...
    m = function() {
        ...
        E = function(a, b) {
            b = b || c.ok;
            var d = [];
            return a.previousSibling && b(a.previousSibling) && d.push(a.previousSibling),
            d.push(a),
        ...
        Q = function(a, b) {
            ...
            function e(c) {
                a !== c && b(c) && d.push(c);
                for (var f = 0,
                g = c.childNodes.length; g > f; f++) e(c.childNodes[f])
            } (a),
            d
        },
        R = function(b, c) {
    ...
    n = function(b, e) {
        ...
        this.initialize = function() {
            return this.layoutInfo = g.createLayout(b, e),
            this._initialize(),
            b.hide(),
            this
        },
        ...
        this._initialize = function() {
            ...
            var c = a.extend({},
            this.options.modules, a.summernote.plugins || {});
        ...
        this.triggerEvent = function() {
            ...
            f && f.apply(b[0], e),
            b.trigger("summernote." + a, e)
        },
        this.initializeModule = function(a) {
            var d = this.modules[a];
            d.shouldInitialize = d.shouldInitialize || c.ok,
            d.shouldInitialize() && (d.initialize && d.initialize(), d.events && m.attachEvents(b, d.events))
        },
        ...
        this.removeModule = function(a) {
            ...
            c.shouldInitialize() && (c.events && m.detachEvents(b, c.events), c.destroy && c.destroy()),
        ...
        this.createInvokeHandler = function(b, c) {
            return function(d) {
                d.preventDefault(),
                f.invoke(b, c || a(d.target).data("value") || a(d.currentTarget).data("value"))
            }
        },
    ...
    a.fn.extend({
        summernote: function() {
            ...
            f = a.extend({},
            a.summernote.options, f),
            f.langInfo = a.extend(!0, {},
            a.summernote.lang["en-US"], a.summernote.lang[f.lang]),
    ...
    z = p.create('<button type="button" class="note-btn btn btn-default btn-sm">',
    function(a, b) {
        b && b.tooltip && a.attr({
            title: b.tooltip
        }).tooltip({
    ...
    A = p.create('<div class="dropdown-menu">',
    function(b, c) {
    ...
    B = p.create('<div class="dropdown-menu note-check">',
    function(b, c) {
        var d = a.isArray(c.items) ? c.items.map(function(a) {
            var b = "string" == typeof a ? a: a.value || "",
            d = c.template ? c.template(a) : a;
    ...
    C = p.create('<div class="note-color-palette"/>',
    function(a, b) {
    ...
    D = p.create('<div class="modal" aria-hidden="false" tabindex="-1"/>',
    function(a, b) {
    ...
    E = p.create(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""),
    function(a, b) {
    ...
    J = function() {
        ...
        e = function(a) {
            ...
            f = b(a.node, a.offset);
            return e.moveToElementText(f.node),
        ...
        f = function(b, g, h, i) {
            ...
            this.scrollIntoView = function(a) {
                return a[0].scrollTop + a.height() < this.sc.offsetTop && (a[0].scrollTop += Math.abs(a[0].scrollTop + a.height() - this.sc.offsetTop)),
                this
            },
            ...
            this.nodes = function(a, b) {
                ...
                i = [],
                j = [];
                return m.walkPoint(g, h,
                function(b) {
                    if (!m.isEditable(b.node)) {
                        var c;
                        f ? (m.isLeftEdgePoint(b) && j.push(b.node), m.isRightEdgePoint(b) && d.contains(j, b.node) && (c = b.node)) : c = e ? m.ancestor(b.node, a) : b.node,
                        c && a(c) && i.push(c)
                    }
                },
                !0),
            ...
            this.expand = function(a) {
                ...
                return c && (e.sc = c, e.so = 0),
                d && (e.ec = d, e.eo = m.nodeLength(d)),
            ...
            this.splitText = function() {
                var a = b === h,
                c = this.getPoints();
                return m.isText(h) && !m.isEdgePoint(this.getEndPoint()) && h.splitText(i),
                m.isText(b) && !m.isEdgePoint(this.getStartPoint()) && (c.sc = b.splitText(g), c.so = 0, a && (c.ec = c.sc, c.eo = i - g)),
            ...
            this.deleteContents = function() {
                ...
                e = m.prevPointUntil(b.getStartPoint(),
                function(a) {
                ...
                function(a, b) {
                    var c = b.parentNode;
                    e.node !== c && 1 === m.nodeLength(c) && g.push(c),
                    m.remove(b, !1)
                }),
                a.each(g,
                function(a, b) {
            ...
            this.isOnEditable = l(m.isEditable),
            this.isOnList = l(m.isList),
            this.isOnAnchor = l(m.isAnchor),
            this.isOnCell = l(m.isCell),
            ...
            this.wrapBodyInlineWithPara = function() {
                if (m.isBodyContainer(b) && m.isEmpty(b)) return b.innerHTML = m.emptyPara,
                ...
                if (m.isInline(a.sc)) {
                    ...
                    e = d.last(g),
                    m.isInline(e) || (e = g[g.length - 2] || a.sc.childNodes[a.so])
            ...
            this.getWordRange = function(a) {
                ...
                var c = m.prevPointUntil(b,
                function(a) {
                    return ! m.isCharPoint(a)
                });
                return a && (b = m.nextPointUntil(b,
                function(a) {
                    return ! m.isCharPoint(a)
                })),
        ...
        return {
            create: function(a, c, d, e) {
                if (arguments.length) 2 === arguments.length && (d = a, e = c);
                    ...
                    var n = b(l, !0),
                    o = b(k, !1);
                    m.isText(n.node) && m.isLeftEdgePoint(n) && m.isTextNode(o.node) && m.isRightEdgePoint(o) && o.node.nextSibling === n.node && (n = o),
                    a = n.cont,
                    c = n.offset,
                    d = o.cont,
                    e = o.offset
            ...
            createFromNode: function(a) {
                ...
                d = a,
                e = m.nodeLength(d);
                return m.isVoid(b) && (c = m.listPrev(b).length - 1, b = b.parentNode),
                m.isBR(d) ? (e = m.listPrev(d).length - 1, d = d.parentNode) : m.isVoid(d) && (e = m.listPrev(d).length, d = d.parentNode),
                this.create(b, c, d, e)
            },
    ...
    L = function(a) {
        ...
        f = function(b) {
            ...
            null !== b.bookmark && J.createFromBookmark(d, b.bookmark).select()
        };
    ...
    M = function() {
        ...
        this.styleNodes = function(b, e) {
            ...
            if (g) {
                ...
                return j.map(function(b) {
                    ...
                    return a.each(f,
                    function(a, b) {
                        m.appendChildNodes(e, b.childNodes),
                        m.remove(b)
                    }),
                    d.head(c)
                })
        ...
        this.current = function(b) {
            ...
            return d.anchor = b.isOnAnchor() && m.ancestor(b.sc, m.isAnchor),
            d.ancestors = m.listAncestor(b.sc, m.isEditable),
            d.range = b,
            d
        }
    },
    N = function() {
        ...
        this.indent = function() {
            ...
            function(c, e) {
                var f = d.head(e);
                m.isLi(f) ? b.wrapList(e, f.parentNode.nodeName) : a.each(e,
                function(b, c) {
                    a(c).css("marginLeft",
                    function(a, b) {
        ...
        this.outdent = function() {
            ...
            function(c, e) {
                var f = d.head(e);
                m.isLi(f) ? b.releaseList([e]) : a.each(e,
                function(b, c) {
                    a(c).css("marginLeft",
                    function(a, b) {
        ...
        this.wrapList = function(a, b) {
            ...
            m.appendChildNodes(h, a),
            g && (m.appendChildNodes(h, d.from(g.childNodes)), m.remove(g)),
            a
        },
        this.releaseList = function(b, c) {
            ...
            function(b, f) {
                ...
                f = c ? m.listDescendant(k, m.isLi) : d.from(k.childNodes).filter(m.isLi),
                (c || !m.isList(i.parentNode)) && (f = f.map(function(a) {
                    return m.replace(a, "P")
                })),
                a.each(d.from(f).reverse(),
                function(a, b) {
                    m.insertAfter(b, i)
                });
    ...
    O = function() {
        ...
        this.insertParagraph = function(c) {
            ...
            if (f) {
                ...
                if (m.isEmpty(f) && m.isPara(f) && m.isBlockquote(f.parentNode)) m.insertAfter(f, f.parentNode),
                e = f;
                else {
                    e = m.splitTree(f, d.getStartPoint());
                    var g = m.listDescendant(f, m.isEmptyAnchor);
                    g = g.concat(m.listDescendant(e, m.isEmptyAnchor)),
                    a.each(g,
                    function(a, b) {
                        m.remove(b)
                    }),
    ...
    R = function(b) {
        ...
        this.initialize = function() {
            g.on("keydown",
            function(a) {
                a.keyCode === I.code.ENTER && b.triggerEvent("enter", a),
        ...
        this.saveRange = function(a) {
            this.focus(),
            g.data("range", J.create()),
            a && J.create().collapse().select()
        },
        ...
        r = this.afterCommand = function(a) {
            p.recordUndo(),
            a || b.triggerEvent("change", g.html())
        },
        ...
        this.insertImage = function(a, c) {
            return K.createImage(a, c).then(function(a) {
                q(),
                "function" == typeof c ? c(a) : ("string" == typeof c && a.attr("data-filename", c), a.css("width", Math.min(g.width(), a.width()))),
                a.show(),
                J.create().insertNode(a[0]),
                J.createFromNodeAfter(a[0]).select(),
                r()
            }).fail(function() {
        ...
        this.insertNode = this.wrapCommand(function(a) {
            J.create().insertNode(a),
            J.createFromNodeAfter(a).select()
        }),
        ...
        this.getSelectedText = function() {
            var a = this.createRange();
            return a.isOnAnchor() && (a = J.createFromNode(m.ancestor(a.sc, m.isAnchor))),
            a.toString()
        },
        ...
        b.memo("help.formatH" + t, i.help["formatH" + t]);
        ...
        this.removeBogus = function() {
            ...
            if (a) {
                ...
                c = b.nodeValue.indexOf(m.ZERO_WIDTH_NBSP_CHAR); - 1 !== c && b.deleteData(c, 1),
                m.isEmpty(a) && m.remove(a),
                g.removeData(Q)
            }
        },
    ...
    S = function(b) {
        ...
        this.initialize = function() {
            this.needKeydownHook() ? (this.$paste = a("<div />").attr("contenteditable", !0).css({
                ...
                left: -1e5,
                opacity: 0
            }), e.before(this.$paste), this.$paste.on("paste",
            function(a) {
                b.triggerEvent("paste", a)
        ...
        this.pasteByHook = function() {
            ...
            if (m.isImg(c)) {
                for (var d = c.src,
                e = atob(d.split(",")[1]), f = new Uint8Array(e.length), g = 0; g < e.length; g++) f[g] = e.charCodeAt(g);
                var h = new Blob([f], {
                    type: "image/png"
                });
    ...
    T = function(b) {
        ...
        this.initialize = function() {
            f.disableDragAndDrop ? c.on("drop",
            function(a) {
                a.preventDefault()
        ...
        this.attachDragAndDropEvent = function() {
            ...
            function(c) {
                ...
                d && d.files && d.files.length ? (c.preventDefault(), e.focus(), b.invoke("editor.insertImagesOrCallback", d.files)) : a.each(d.types,
                function(c, e) {
                    var f = d.getData(e);
    ...
    j.hasCodeMirror && (j.isSupportAmd ? require(["codemirror"],
    function(a) {
        H = a
    }) : H = window.CodeMirror);
    var U = function(a) {
    ...
    W = function(b) {
        ...
        f = b.options;
        this.initialize = function() {
            f.airMode || f.disableResizeEditor || d.on("mousedown",
            function(a) {
                a.preventDefault(),
                a.stopPropagation();
    ...
    X = function(b) {
        ...
        this.toggle = function() {
            ...
            i ? (e.data("orgHeight", e.css("height")), g.on("resize",
            function() {
                a({
            ...
            b.invoke("toolbar.updateFullscreen", i)
        }
    },
    Y = function(b) {
        var c = this,
    ...
    aa = function(b) {
        ...
        l = this.representShortcut = function(a) {
            var b = k[a];
            return j.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")),
        ...
        this.addToolbarButtons = function() {
            ...
            b.memo("button.justifyLeft", c.invoke(g, "render")),
            b.memo("button.justifyCenter", c.invoke(k, "render")),
            b.memo("button.justifyRight", c.invoke(m, "render")),
            b.memo("button.justifyFull", c.invoke(n, "render")),
            b.memo("button.outdent", c.invoke(o, "render")),
            b.memo("button.indent", c.invoke(p, "render")),
            b.memo("button.paragraph",
            function() {
                return f.buttonGroup([f.button({
                    className: "dropdown-toggle",
        ...
        this.tableMoveHandler = function(b) {
            ...
            3 < l.c && l.c < h.insertTableMaxSize.col && j.css({
                width: l.c + 1 + "em"
            }),
    ...
    ba = function(b) {
        ...
        this.initialize = function() {
            f.toolbar = f.toolbar || [],
            f.toolbar.length ? b.invoke("buttons.build", e, f.toolbar) : e.hide(),
            f.toolbarContainer && e.appendTo(f.toolbarContainer),
            d.on("summernote.keyup summernote.mouseup summernote.change",
            function() {
        ...
        this.showLinkDialog = function(e) {
            return a.Deferred(function(a) {
                ...
                function() {
                    ...
                    e.url || (e.url = e.text || "http://", d.toggleBtn(h, e.text)),
                    g.on("input",
                    function() {
                        d.toggleBtn(h, f.val() && g.val()),
                        e.text || f.val(g.val())
    ...
    ha = function(b) {
        ...
        this.initialize = function() {
            var b = f.dialogsInBody ? a(document.body) : e,
            c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.7.2</a> · ', '<a href="//github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = d.dialog({
    ...
    ja = function(b) {
        ...
        this.replace = function() {
            ...
            if (a.length) {
                ...
                J.createFromNode(c).collapse().select(),
                this.lastWordRange = null,
                this.hide(),
                b.invoke("editor.focus")
            }
        ...
        this.nodeFromItem = function(a) {
            ...
            return "string" == typeof d && (d = m.createText(d)),
            d
        },
