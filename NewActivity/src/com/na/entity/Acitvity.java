...
/**
 * Acitvity entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "tb_activity")
public class Acitvity implements java.io.Serializable {
	...
	/** minimal constructor */
	public Acitvity(String title, Timestamp createtime) {
		this.title = title;
		this.createtime = createtime;
	}

	/** full constructor */
	public Acitvity(String title, String content, Timestamp starttime,
