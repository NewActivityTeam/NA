...
<script>
	...
	function TestContent(sub, content) {
		...
		case 6:
			if (content == ""
					|| (content != "" && !/.+@.+\.[a-zA-Z]{2,4}$/.test(content))) {
				return false;
			}
			break;
		}
	...
	<div data-role="page">
		...
		<div data-role="content" id="main" class="ui-content">
			...
			<c:if test="${state == 1 }">
				<c:if test="${userinfo.name!=null}">
					<ul data-role="listview">
						<li data-role="list-divider"
							class="ui-btn ui-icon-user ui-btn-icon-right"
							style="background-color:#29c1e8;;color:white"><h5
								style="margin:0;font-weight:100;">基本信息</h5></li>
						<li>易班ID：
						...
						<li>性别：
							<div style="float: right;">
								<b> <c:if test="${userinfo.sex==0}">男</c:if> <c:if
										test="${userinfo.sex==1}">女</c:if>
								</b>
							</div>
						</li>
						<li data-role="list-divider"
							class="ui-btn ui-icon-edit ui-btn-icon-right"
							style="font-family:宋体;font-weight:100;background-color:#29c1e8;;color:white;"><h5
								style="margin:0;font-weight:100;">可修改信息</h5></li>
						<li data-icon="edit"><a href="#changeAge" data-rel="popup"
							class="ui-btn" data-transition="pop" data-position-to="window">年龄：
								<div style="float: right;" id="ageInfo">${userinfo.age}</div>
						</a></li>
						<li data-icon="edit"><a href="#changeHeight" data-rel="popup"
							class="ui-btn" data-transition="pop" data-position-to="window">身高：
								<div style="float: right;" id="heightInfo">${userinfo.height}
									cm</div>
						</a></li>
						<li data-icon="edit"><a href="#changeWeight" data-rel="popup"
							class="ui-btn" data-transition="pop" data-position-to="window">体重：
								<div style="float: right;" id="weightInfo">${userinfo.weight}
									kg</div>
						</a></li>
						<li data-icon="edit"><a href="#changePhone" data-rel="popup"
							class="ui-btn" data-transition="pop" data-position-to="window">手机号：
								<div style="float: right;" id="phoneInfo">${userinfo.phonenumber}</div>
						</a></li>
						<li data-icon="edit"><a href="#changeEmail" data-rel="popup"
							class="ui-btn" data-transition="pop" data-position-to="window">Email：
								<div style="float: right;" id="emailInfo">${userinfo.email}</div>
						</a></li>
					</ul>
				</c:if>
				<c:if test="${userinfo.name==null}">
					...
					<a data-ajax="false"
						href="${pageContext.request.contextPath}/test/user/setuserinfo?display=mobile"
						class="ui-btn ui-icon-edit ui-btn-icon-top">点击设置</a>
				</c:if>
				<div data-role="popup" id="changeAge" class="ui-content popup"
				...
				<div data-role="popup" id="changeHeight" class="ui-content popup"
					data-overlay-theme="b">
					<a href="#" data-rel="back"
						class="ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right">关闭</a>
					<div data-role="header">
					...
					<input type="text" name="content" id="newHeight"
						placeholder="请输入新身高(cm)">
					<p id="heightErr" style="display: none; color: red;">请输入合法的身高（30-300）</p>
					<a href="#messageBox" class="ui-btn" id="heightSub">提交</a>
				</div>
				<div data-role="popup" id="changeWeight" class="ui-content popup"
					data-overlay-theme="b">
					<a href="#" data-rel="back"
						class="ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right">关闭</a>
					<div data-role="header">
					...
					<input type="text" name="content" id="newWeight"
						placeholder="请输入新体重(kg)">
					<p id="weightErr" style="display: none; color: red;">请输入合法的体重（3-300）</p>
					<a href="#messageBox" class="ui-btn" id="weightSub">提交</a>
				</div>
				<div data-role="popup" id="changePhone" class="ui-content popup"
					data-overlay-theme="b">
					<a href="#" data-rel="back"
						class="ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right">关闭</a>
					<div data-role="header">
				...
				<div data-role="popup" id="changeEmail" class="ui-content popup"
					...
					<input type="text" name="content" id="newEmail"
						placeholder="请输入电子邮箱">
